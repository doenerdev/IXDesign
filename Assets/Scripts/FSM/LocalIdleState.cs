...
public class LocalIdleState : FSMState {

    private GameObject _character;
    private AvatarController _controller;

    public LocalIdleState(GameObject character, AvatarController controller)
    {
        stateID = StateID.LocalIdle;
    ...
    public override void Reason()
    {
        ...
        {
            _character.GetComponent<AvatarController>().SetTransition(Transition.LocalControlStarted);
        }
    }
